...
const userData = {
  name: "РАҲИМА ҒАФУРОВА",
  title: "Тренер по кардио нагрузкам",
  status: "На работе",
  phone: "+992 92 000 00 00",
  bgImages: [headerBg, headerBg, headerBg], 
};
...
const UserProfileCard = () => {
  ...
  const totalSlides = userData.bgImages.length;
  const imageTranslate = `translateX(-${currentSlide * 100 / totalSlides}%)`;

  return (
    <div className="
      w-full mx-auto text-white overflow-hidden 
      shadow-2xl relative
    ">
      <div>
        <div className="h-80 rounded-3xl m-0 relative overflow-hidden">
          ...
          >
            {userData.bgImages.map((imgSrc, index) => (
              <img 
                key={index}
                src={imgSrc} 
        ...
        <div className="absolute top-60 left-15 z-20">
          <div className="
            ...
            outline-6 outline-[var(--color-accent)] 
            
          ">
            <img src={profileMain} alt="Акси асосии профили" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
        ...
        <div className="px-10 pt-8 min-h-32"> 
          <div className="flex justify-between items-start mb-2">
            <div className="flex items-center gap-1">
              ...
              <path d="M22.2969 8.4589L16.4833 2.70548L18.3984 0.787671C18.9228 0.262557 19.5671 0 20.3313 0C21.0955 0 21.7393 0.262557 22.2628 0.787671L24.1778 2.70548C24.7022 3.23059 24.9758 3.86438 24.9986 4.60685C25.0214 5.34931 24.7706 5.98265 24.2462 6.50685L22.2969 8.4589ZM20.3135 10.4795L5.81362 25H0V19.1781L14.4999 4.65753L20.3135 10.4795Z" fill="#3A3A3C"/>
              </svg>
            </div>
          ...
          <p className="text-gray-200 ">{userData.title}</p>
