...
const ProfileHeader = () => {
  return (
    <header className="w-full mx-auto flex justify-between items-center mb-4 py-2 px-2 md:px-0">
      
      <button 
        onClick={() => console.log("Ба саҳифаи қаблӣ баргард")}
      ...
      <button 
        onClick={() => console.log("Маълумотро мубодила кун")}
        className="
          color-bg-card
          w-15 h-13 
          rounded-xl 
      ...
      >
          ...
          <path fill-rule="evenodd" clip-rule="evenodd" d="M10.0002 19.0256C11.9332 19.0256 13.5002 17.4988 13.5002 15.6154C13.5002 13.732 11.9332 12.2052 10.0002 12.2052C8.06723 12.2052 6.50022 13.732 6.50022 15.6154C6.50022 17.4988 8.06723 19.0256 10.0002 19.0256ZM14.5002 15.6154C14.5002 18.0369 12.4855 20 10.0002 20C7.51495 20 5.50022 18.0369 5.50022 15.6154C5.50022 13.1939 7.51495 11.2308 10.0002 11.2308C12.4855 11.2308 14.5002 13.1939 14.5002 15.6154Z" fill="#D0FD3E" stroke="#D0FD3E"/>
          <path d="M24.3496 16.0898L14.6504 16.0898C14.5552 16.0898 14.5 16.0175 14.5 15.9561C14.5003 15.8947 14.5555 15.8232 14.6504 15.8232L24.3496 15.8232C24.4445 15.8232 24.4997 15.8947 24.5 15.9561C24.5 16.0175 24.4448 16.0898 24.3496 16.0898Z" fill="#D0FD3E" stroke="#D0FD3E"/>
