...
export default function SearchBlockedUsers({ data }) {
  ...
  return (
    <div className="relative">
      ...
      <svg
          ...
          className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 bg-hover-card pointer-events-none z-30"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
      >
